"""
Django settings for jobgy project.
...
SECRET_KEY = 'r$ly)mpy0-eiz8x=3cjfkg26wn3sq9_5y60=wcqnh5!!+!r^dc'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'EmpUserInfo')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'jobgy.wsgi.application'
